  ...
  <div id="mint-container">
    <div class="assets-container">
      <b-row>
        ...
        <Asset v-bind:assets="[{text: 'RUNE', value: 'THOR.RUNE'}]" v-bind:is-origin-asset="false"/>
      </b-row>
    ...
    <b-row>
      <button v-if="isWalletConnected" class="button-execution" v-on:click="burn" >BURN IT</button>
